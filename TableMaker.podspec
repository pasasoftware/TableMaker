#
# Be sure to run `pod lib lint TableMaker.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'http://27.154.55.14:8086/mobile/TableMaker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'guanping.cai' => 'andrew@measuresquare.com' }
  s.source           = { :git => 'ssh://git@27.154.55.14:8888/mobile/TableMaker.git', :tag => s.version.to_s }
